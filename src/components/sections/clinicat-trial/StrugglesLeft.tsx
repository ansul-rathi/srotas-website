...
const struggles = [
  {
    id: 0,
    icon: "/images/trial/clock.svg",
    title: "Sites generate 1000’s of patient leads, but most don’t meet trial criteria. Teams spend weeks chasing the wrong candidates.",
  ...
  {
    id: 1,
    icon: "/images/trial/group.svg",
    title: "Spend countless hours on telescreening, mapping patients to criteria(avg. 40 min/patient), and manual entry.",
  ...
  },
  {
    id: 2,
    icon: "/images/trial/group.svg",
    title: "Sites lose patient's at each stage of evaluation. In one study, 3,100 leads converted to 7 enrolments (0.22%)",
  ...
  {
    id: 3,
    icon: "/images/trial/light.svg",
    title: "For CROs and sponsors, delays mean missed milestones, rising costs, and patients waiting longer for treatment.",
    ...
    <div className="grid grid-cols-1 md:grid-cols-2 w-full bg-[#FAFAFA] rounded-lg shadow-sm">
      ...
      <div className="space-y-6 border-l-[1px] border-[#9F9C9C]">
        <div className=" border-l-[10px] border-white">
          ...
          <div className="my-28 ml-11">
          {struggles.map((item, index) => (
            <div
              key={item.id}
              onClick={() => setSelected(index)}
              className={`flex mb-10 p-3 rounded-lg cursor-pointer transition 
              ${
                selected === index
                  ? "text-[#6C47FF]"
                  : ""
            ...
            >
              ...
              <div>
                <p
                  className={`text-[16px] font-normal ml-4 ${
                    selected === index
                      ? item.textColor
                      : "text-gray-700"
                  }`}
          ...
          <div className="bg-[#6C47FF] px-14 py-11">
            <div className="flex text-white font-bold text-2xl md:text-3xl items-center">
              <div className="text-[60px] font-semibold font-dm ">
              80%
              </div>
              <span className="font-normal text-white text-normal text-[20px] font-helvetica pl-10 leading-7">
