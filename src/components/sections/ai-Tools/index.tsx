    ...
    return (
        <section className="bg-gray-200 pb-28">
            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <div className="max-w-3xl mx-auto mb-8 md:mb-12">
                    <Tabs
                        ...
                        classNames={{
                            ...
                            tab: "h-12 px-4 md:px-8 bg-gray-200 data-[selected=true]:bg-black data-[selected=true]:text-white transition-colors",
                            cursor: "bg-white",
                            panel: "pt-4",
                        }}
                    >
                ...
                {toolsData.map((tool) => (
                    tool.id === selected && (
                        <div key={tool.id} className="bg-[#120F24] p-4 md:p-8 lg:p-12">
                            <div className="flex flex-col lg:flex-row gap-6 lg:gap-12">
                                ...
                                <div className="flex flex-col w-full lg:w-1/2 text-white justify-center">
                                    ...
                                    <Button
                                        className="bg-blue-600 hover:bg-blue-700 text-white px-6 md:px-8 py-2 h-10 md:h-12 w-full md:w-5/12 transition-colors"
                                        endContent={
